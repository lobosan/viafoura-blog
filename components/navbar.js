    ...
    <nav class="top-0 absolute z-50 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg bg-blueGray-800">
      <div class="container px-4 mx-auto flex flex-wrap items-center justify-between">
        <div class="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start ">
          <a
            class="text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase text-gray-700"
            href="../../index.html"
          >
            Notus JS
          </a>
          ...
          >
            <i class="text-green-600 fas fa-bars"></i>
          </button>
        </div>
        <div
          class="lg:flex flex-grow items-center bg-red-500 lg:bg-opacity-0 lg:shadow-none hidden bg-blueGray-800"
        ...
        >
          <ul class="flex flex-col lg:flex-row list-none mr-auto">
            <li class="flex items-center">
              ...
              >
                <i class="lg:text-blueGray-200 text-blueGray-400 far fa-file-alt text-lg leading-lg mr-2"></i>
                Docs
              </a>
            </li>
          </ul>
          <ul class="flex flex-col lg:flex-row list-none lg:ml-auto items-center">
            <li class="inline-block relative">
              ...
              <div
                class="hidden bg-gray-700 text-base z-50 float-left py-2 list-none text-left rounded shadow-lg min-w-48"
            ...
            <li class="flex items-center">
              <a
                class="lg:text-gray-700 lg:hover:text-blueGray-200 text-blueGray-700 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
                href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdemos.creative-tim.com%2Fnotus-js%2F"
                target="_blank"
              >
                <i class="lg:text-blueGray-200 text-blueGray-400 fab fa-facebook text-lg leading-lg"></i>
